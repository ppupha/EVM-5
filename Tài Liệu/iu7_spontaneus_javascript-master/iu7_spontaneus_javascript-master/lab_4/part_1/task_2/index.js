...
class ServerC {
	...
	constructor(port) {
		...
		/*this.app.get('/Task71/1', this.Task71);
		this.app.get('/Task71/2', this.Task72);
		this.app.get('/Task71/3', this.Task73);
		this.app.get('/Task71/4', this.Task74);*/
		console.log(" Server started succesfully!");
	}
	...
	Task71(request, response){
		response.redirect('http://localhost:5025/html/add_car.html')
	}
	
	Task72(request, response){
		response.redirect('http://localhost:5025/html/get_car.html')
	}

	
	Task73(request, response){
		response.redirect('http://localhost:5025/html/add_storage.html')
	}

	
	Task74(request, response){
		response.redirect('http://localhost:5025/html/get_storage.html')
	}
